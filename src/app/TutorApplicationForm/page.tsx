    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate p-6">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-700 text-white text-lg font-semibold py-3 rounded-2xl hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-300 "
          >
            Enviar candidatura
          </button>
        </form>
