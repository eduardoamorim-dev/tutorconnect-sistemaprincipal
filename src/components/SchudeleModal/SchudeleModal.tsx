                    ...
                    <div className="space-y-2">
                        {availableSlots.map(slot => (
                            <button
                                ...
                                className={`w-full p-2 text-left rounded ${selectedDate === slot.date ? 'bg-blue-100 text-blue-700' : 'bg-gray-100'
                                    }`}
                            >
                                {slot.date}
                            </button>
                    ...
                    <div className="space-y-2">
                        {selectedDate && availableSlots.find(slot => slot.date === selectedDate)?.times.map(time => (
                            <button
                                ...
                                className={`w-full p-2 text-left rounded flex items-center ${selectedTime === time ? 'bg-blue-100 text-blue-700' : 'bg-gray-100'
                                    }`}
                            >
